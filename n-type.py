...
Source_Voltage=(abs(y["Source Voltage"].values))[0:len(vg100)]
df=pandas.DataFrame({'VDS':Source_Voltage,'vg=0':vg01,'vg=10':vg1101,'vg=20':vg2101,'vg=30':vg3101,'vg=40':vg4101,'vg=50':vg5101,'vg=60':vg6101,'vg=70':vg7101,'vg=80':vg8101,'vg=90':vg9101,'vg=one-hundred':vg11001})
pandas.set_option('display.max_columns', 90000)
df.to_csv('n-type_processed.csv',index=False)
